...
<script type ="text/javascript" src="resources/javascript/vendor/raphael/raphael.min.js"></script>

<!-- Custom Theme JavaScript -->
<script type ="text/javascript" src="resources/javascript/dist/js/sb-admin-2.js"></script>